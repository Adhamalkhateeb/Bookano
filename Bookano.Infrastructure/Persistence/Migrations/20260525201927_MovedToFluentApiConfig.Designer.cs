...
namespace Bookano.Infrastructure.Persistence
{
    ...
    [Migration("20260525201927_MovedToFluentApiConfig")]
    partial class MovedToFluentApiConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.BookAuthor", b =>
                {
                    b.HasOne("Bookano.Domain.Entities.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Bookano.Domain.Entities.Book", "Book")
                        .WithMany("Authors")
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.BookCategory", b =>
                {
                    ...
                    b.HasOne("Bookano.Domain.Entities.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.Rental", b =>
                {
                    ...
                    b.HasOne("Bookano.Domain.Entities.Subscriber", "Subscriber")
                        .WithMany("Rentals")
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.RentalCopy", b =>
                {
                    b.HasOne("Bookano.Domain.Entities.BookCopy", "BookCopy")
                        .WithMany("Rentals")
                        .HasForeignKey("BookCopyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Bookano.Domain.Entities.Rental", "Rental")
            ...
            modelBuilder.Entity("Bookano.Domain.Entities.Subscriber", b =>
                {
                    b.HasOne("Bookano.Domain.Entities.Area", "Area")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bookano.Domain.Entities.ApplicationUser", null)
                        .WithMany()
